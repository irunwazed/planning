...
class AdminModel extends CI_Model
{
    ...
    public function setQuery($post){
        ...
        $this->db->join('ref_kelurahan', '
            ref_kelurahan.Kd_Urut = '.$this->table.'.Kd_Urut_Kel
            ...
            and ref_kelurahan.Kd_Prov = '.$this->table.'.Kd_Prov
            ', 'left');
        $this->db->join('ref_kecamatan', '
            ref_kecamatan.Kd_Kec = '.$this->table.'.Kd_Kec
            and ref_kecamatan.Kd_Kab = '.$this->table.'.Kd_Kab
            and ref_kecamatan.Kd_Prov = '.$this->table.'.Kd_Prov
            ', 'left');
    ...
    public function getCountKiriman($post, $kd_kec = null, $pokir = false, $post = array()){
    ...
    public function getAllKiriman($post, $all = false, $post = array()){
        $jumlah = $this->jumlah;

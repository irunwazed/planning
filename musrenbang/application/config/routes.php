...
$route['kecamatan/set-usulan-terima'] = "KecamatanController/usulanTerima";
...
$route['opd/page-(:num)'] = "OpdController/getData/$1";
$route['opd/set-usulan-terima'] = "OpdController/usulanTerima";
$route['opd/get-pdf/(:any)'] = "OpdController/getPdf/$1";

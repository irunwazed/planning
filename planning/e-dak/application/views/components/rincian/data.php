    ...
    <section class="content-header">
      <h1>
      Rincian
        <small>Mengolah data rincian</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label>Kode</label>
              <input name="rincian_kode" type="text" class="form-control" required autofocus>
            </div>
            <div class="form-group">
              <label>Nomenklatur Rincian</label>
              <input name="rincian_nama" type="text" class="form-control" required autofocus>
            </div>
          </div>

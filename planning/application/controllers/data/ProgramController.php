...
class ProgramController extends CI_Controller {
    ...
    {
		parent::__construct();
        $this->load->model('data/ProgramModel');
    ...
    public function view($kode){
        ...
        $file['content'] = $this->load->view('components/data-program/content', $data, true);
        $file['script'] = $this->load->view('components/data-program/script', $data, true);

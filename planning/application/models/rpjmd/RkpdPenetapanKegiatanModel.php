...
class RkpdPenetapanKegiatanModel extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->tableIndikator = 'tb_rpjmd_kegiatan_indikator_penetapan';
    ...
    public function cekInput($post){
        ...
        if(@$hak['rkpdPenetapan']['kegiatan'] && in_array($this->session->tahun, @$hak['rkpdPenetapan']['tahun']))$jalan = true;

...
class RkpdPenetapanModel extends CI_Model
{
    ...
    public function create($post){
        ...
        if($this->cekInput($post)){
            ...
            $post['tb_rpjmd_program_target_realisasi'] = $this->fungsi->convert_to_number($post['tb_rpjmd_program_target_realisasi']);

            $kode = explode("-", $post['sasaran']);
            $kodeOpd = explode("-", $this->session->kodeOpd);
            $data = array(
                ...
                'tb_rpjmd_program_target_kinerja' => $post['tb_rpjmd_program_target_kinerja'],
                'tb_rpjmd_program_target_realisasi' => $post['tb_rpjmd_program_target_realisasi'],
                'tb_rpjmd_program_catatan' => $post['tb_rpjmd_program_catatan'],
    ...
    public function cekInput($post){
        ...
        if(@$hak['rkpdPenetapan']['program'] && in_array($this->session->tahun, @$hak['rkpdPenetapan']['tahun']))$jalan = true;

...
class Rek5Model extends CI_Model
{
    ...
    public function setQuery($post){
        ...
        $this->db->join('tb_rekening5', 'tb_rekening5.tb_rekening1_kode = '.$this->table.'.tb_rekening1_kode
                                        ...
                                        AND tb_rekening5.tb_rekening4_kode = '.$this->table.'.tb_rekening4_kode
    ...
    public function create($post){
        ...
        if($this->cekInput($post)){
            ...
            $post['tb_monev_lra_rek5_anggaran'] = $this->fungsi->convert_to_number($post['tb_monev_lra_rek5_anggaran']);
            $post['tb_monev_lra_rek5_realisasi'] = $this->fungsi->convert_to_number($post['tb_monev_lra_rek5_realisasi']);
            $kodeOpd = explode("-", $this->session->kodeOpd);
            $kode = explode("-", $post['kode']);
            $data = array(

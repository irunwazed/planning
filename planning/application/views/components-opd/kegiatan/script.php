        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-data">
                    ...
                    <div class="position-relative form-group">
                        <label>Satuan</label>
                        <select name="id_tb_satuan" class="form-control select2" style="width: 100%" required>
                    ...
                    <div class="position-relative form-group">
                        ...
                        <input name="tb_rpjmd_kegiatan_th_awal_target_kinerja" type="text" class="form-control" required>
                    </div>
                    <div class="position-relative form-group">
                        <label>Pagu Awal</label>
                        <input name="tb_rpjmd_kegiatan_th_awal_target_realisasi" onchange="inputToRupiah(this)" type="text" class="form-control" required>
                    </div>
                    <div class="position-relative form-group">
                        <label>Target Kenirja Tahun 1</label>
                        <input name="tb_rpjmd_kegiatan_th1_target_kinerja" type="text" class="form-control" required>
                    </div>
                    <div class="position-relative form-group">
                        <label>Target Kenirja Tahun 2</label>
                        <input name="tb_rpjmd_kegiatan_th2_target_kinerja" type="text" class="form-control" required>
                    </div>
                    <div class="position-relative form-group">
                        <label>Target Kenirja Tahun 3</label>
                        <input name="tb_rpjmd_kegiatan_th3_target_kinerja" type="text" class="form-control" required>
                    </div>
                    <div class="position-relative form-group">
                        <label>Target Kenirja Tahun 4</label>
                        <input name="tb_rpjmd_kegiatan_th4_target_kinerja" type="text" class="form-control" required>
                    </div>
                    <div class="position-relative form-group">
                        <label>Target Kenirja Tahun 5</label>
                        <input name="tb_rpjmd_kegiatan_th5_target_kinerja" type="text" class="form-control" required>
                    </div>
                    <div class="position-relative form-group">
                        <label>Target Realisasi Tahun 1</label>
                        <input name="tb_rpjmd_kegiatan_th1_target_realisasi" onchange="inputToRupiah(this)" type="text" class="form-control" required>
                    </div>
                    <div class="position-relative form-group">
                        <label>Target Realisasi Tahun 2</label>
                        <input name="tb_rpjmd_kegiatan_th2_target_realisasi" onchange="inputToRupiah(this)" type="text" class="form-control" required>
                    </div>
                    <div class="position-relative form-group">
                        <label>Target Realisasi Tahun 3</label>
                        <input name="tb_rpjmd_kegiatan_th3_target_realisasi" onchange="inputToRupiah(this)" type="text" class="form-control" required>
                    </div>
                    <div class="position-relative form-group">
                        <label>Target Realisasi Tahun 4</label>
                        <input name="tb_rpjmd_kegiatan_th4_target_realisasi" onchange="inputToRupiah(this)" type="text" class="form-control" required>
                    </div>
                    <div class="position-relative form-group">
...
<div class="modal fade bd-example-modal-lg" id="modal-indikator" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-indikator" action="<?=base_url()?>renstra/penyusunan/kegiatan/indikator">
                    ...
                    <div id="isi-indikator">
                        <div class="form-group" id="indikator-input-1">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <input name="tb_rpjmd_kegiatan_indikator_nama[]" type="text" class="form-control" required>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    var link = 'renstra/penyusunan/kegiatan';
    var page = 1;
    getData();
    ...
    function setTable(data){
        ...
        data.forEach(element => {
            ...
            tempData = [
                ...
                convertToRupiah(element['tb_rpjmd_kegiatan_th_awal_target_realisasi']),
                element['tb_rpjmd_kegiatan_th1_target_kinerja'],
                convertToRupiah(element['tb_rpjmd_kegiatan_th1_target_realisasi']),
                element['tb_rpjmd_kegiatan_th2_target_kinerja'],
                convertToRupiah(element['tb_rpjmd_kegiatan_th2_target_realisasi']),
                element['tb_rpjmd_kegiatan_th3_target_kinerja'],
                convertToRupiah(element['tb_rpjmd_kegiatan_th3_target_realisasi']),
                element['tb_rpjmd_kegiatan_th4_target_kinerja'],
                convertToRupiah(element['tb_rpjmd_kegiatan_th4_target_realisasi']),
    ...
    function setForm(data){
        ...
        $("input[name='tb_rpjmd_kegiatan_indikator']").val(data['tb_rpjmd_kegiatan_indikator']);
        $("input[name='tb_rpjmd_kegiatan_th_awal_target_kinerja']").val(data['tb_rpjmd_kegiatan_th_awal_target_kinerja']);
        $("input[name='tb_rpjmd_kegiatan_th_awal_target_realisasi']").val(data['tb_rpjmd_kegiatan_th_awal_target_realisasi']);
        $("input[name='tb_rpjmd_kegiatan_th1_target_kinerja']").val(data['tb_rpjmd_kegiatan_th1_target_kinerja']);
        $("input[name='tb_rpjmd_kegiatan_th2_target_kinerja']").val(data['tb_rpjmd_kegiatan_th2_target_kinerja']);
        $("input[name='tb_rpjmd_kegiatan_th3_target_kinerja']").val(data['tb_rpjmd_kegiatan_th3_target_kinerja']);
        $("input[name='tb_rpjmd_kegiatan_th4_target_kinerja']").val(data['tb_rpjmd_kegiatan_th4_target_kinerja']);
        $("input[name='tb_rpjmd_kegiatan_th5_target_kinerja']").val(data['tb_rpjmd_kegiatan_th5_target_kinerja']);
        $("input[name='tb_rpjmd_kegiatan_th1_target_realisasi']").val(data['tb_rpjmd_kegiatan_th1_target_realisasi']);
        $("input[name='tb_rpjmd_kegiatan_th2_target_realisasi']").val(data['tb_rpjmd_kegiatan_th2_target_realisasi']);
        $("input[name='tb_rpjmd_kegiatan_th3_target_realisasi']").val(data['tb_rpjmd_kegiatan_th3_target_realisasi']);
        $("input[name='tb_rpjmd_kegiatan_th4_target_realisasi']").val(data['tb_rpjmd_kegiatan_th4_target_realisasi']);
        $("input[name='tb_rpjmd_kegiatan_th5_target_realisasi']").val(data['tb_rpjmd_kegiatan_th5_target_realisasi']);
        $("input[name='tb_rpjmd_kegiatan_th_akhir_target_kinerja']").val(data['tb_rpjmd_kegiatan_th_akhir_target_kinerja']);
        $("input[name='tb_rpjmd_kegiatan_th_akhir_target_realisasi']").val(data['tb_rpjmd_kegiatan_th_akhir_target_realisasi']);
    }
    ...
    function setIndikator(id){
        ...
        if(dataPilih['indikator'].length > 0){
            isiIndikator(indexIndikator, dataPilih['indikator'][0]['tb_rpjmd_kegiatan_indikator_nama']);
        }
        for(let i = 1; i < dataPilih['indikator'].length; i++){
            addIndikator();
            isiIndikator(indexIndikator, dataPilih['indikator'][i]['tb_rpjmd_kegiatan_indikator_nama']);
        }
    ...
    function setIsiIndikator(){
        ...
        let isi =   '<div class="form-group" id="indikator-input-'+indexIndikator+'">'+
                        ...
                        '<div class="row">'+
                            '<div class="col-12">'+
                                '<input name="tb_rpjmd_kegiatan_indikator_nama[]" id="indikator-'+indexIndikator+'" type="text" class="form-control" required>'+
                            '</div>'+
                        '</div>'+
                    '</div>';
        frame.empty();

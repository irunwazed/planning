            ...
            <div class="modal-body">
                <form id="form-data">
                    ...
                    <div class="position-relative form-group">
                        ...
                        <select name="tb_rekening2_kode" class="form-control" required>
                            <option value="1">BELANJA TIDAK LANGSUNG</option>
                            <option value="2">BELANJA LANGSUNG</option>
                        </select>
                    </div>
                </form>
            </div>
...
<script type="text/javascript">
    ...
    var link = 'opd/penyusunan/lra/rek2';
    var page = 1;
    getData();
    ...
    function setTable(data){
        ...
        data.forEach(element => {
            ...
            kodeShow =  element['tb_rekening1_kode']
                        +'.'+element['tb_rekening2_kode'];
            setLink = 'opd/penyusunan/lra/rek3/'+kodeOneData+'-0-0';
            if(parseInt(element['tb_rekening2_kode']) == 2){
                setLink = 'opd/penyusunan/lra/rek2-program/'+kodeOneData;
            }
            tempData = [
                no,
                kodeShow,
                '<a href="'+base_url+setLink+'">'+element['tb_rekening2_nama']+'</a>',
    ...
    function setForm(data){
        ...
        $("select[name='tb_rekening2_kode']").val(data['tb_rekening2_kode']);
    }

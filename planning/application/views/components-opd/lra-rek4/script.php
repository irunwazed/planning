            ...
            <div class="modal-body">
                <form id="form-data">
                    ...
                    <div class="position-relative form-group">
                        ...
                        <select name="tb_rekening4_kode" class="form-control select2" style="width: 100%" required>
                            <option value="">-= Pilih Rekening =-</option>
                            <?php foreach($dataRekening as $row){ ?>
                                <option value="<?=$row['tb_rekening4_kode']?>"><?=$row['tb_rekening4_nama']?></option>
                            <?php } ?>
                        </select>
                    </div>
                </form>
...
<script type="text/javascript">
    ...
    var link = 'opd/penyusunan/lra/rek4';
    var page = 1;
    getData();
    ...
    function setTable(data){
        ...
        data.forEach(element => {
            ...
            tempData = [
                no,
                kodeShow,
                '<a href="'+base_url+'opd/penyusunan/lra/rek5/'+kodeOneData+'">'+element['tb_rekening4_nama']+'</a>',
    ...
    function setForm(data){
        ...
        $("select[name='tb_rekening4_kode']").val(data['tb_rekening4_kode']);
    }

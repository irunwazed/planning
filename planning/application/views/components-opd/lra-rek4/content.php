                        ...
                        <div class="app-page-title" >
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions">
                                    <a href="<?=base_url()?>opd/penyusunan/lra/rek3/<?=@$kode?>" data-toggle="tooltip" title="Kembali" data-placement="bottom" class="btn-shadow mr-3 btn btn-info">
                                            ...
                                            <div>
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="10">:</td>
                                                        <td><?="(".@$dataLra->tb_rekening3_kode.") ".@$dataLra->tb_rekening3_nama?></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div class="page-title-wrapper">

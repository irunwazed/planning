                        ...
                        <div class="app-page-title" >
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions">
                                    <a href="<?=base_url()?>renstra/penyusunan/kegiatan/<?=@$kode?>" data-toggle="tooltip" title="Kembali" data-placement="bottom" class="btn-shadow mr-3 btn btn-info">
                                            ...
                                            <div>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td width="10">:</td>
                                                        <td><a href="<?=base_url()?>renstra/penyusunan/program"><?="(".@$dataRpjmd->tb_rpjmd_misi_kode.".".@$dataRpjmd->tb_rpjmd_tujuan_kode.".".@$dataRpjmd->tb_rpjmd_sasaran_kode.") ".@$dataRpjmd->tb_rpjmd_sasaran_nama?></a></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="10">:</td>
                                                        <td><a href="<?=base_url()?>renstra/penyusunan/kegiatan/<?=$kode?>"><?="(".@$dataRpjmd->tb_program_kode.") ".@$dataRpjmd->tb_program_nama?></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="80">Kegiatan</td>
                                                        <td width="10">:</td>
                                                        <td><?="(".@$dataRpjmd->tb_kegiatan_kode.") ".@$dataRpjmd->tb_kegiatan_nama?></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div class="page-title-wrapper">
                                            ...
                                            <table class="mb-0 table table-bordered table-hover table-striped" id="table-data" style="width: 100%">
                                                <thead>
                                                    <tr class="mytable-head">
                                                        <th width="20" rowspan="2" class="align-middle">No</th>
                                                        <th rowspan="2" class="align-middle">Tahun</th>
                                                        <th rowspan="2" class="align-middle">Bulan</th>
                                                        <th colspan="3" class="align-middle">Capaian</th>
                                                        <th rowspan="2" class="align-middle">Fisik</th>
                                                        <th rowspan="2" class="align-middle">Pelaksana</th>
                                                        <th width="80" rowspan="2" class="align-middle">Aksi</th>
                                                    </tr>
                                                    <tr class="mytable-head">
                                                        <th class="align-middle">Kierja</th>

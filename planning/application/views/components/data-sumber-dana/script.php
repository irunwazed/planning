            ...
            <div class="modal-body">
                <form id="form-data">
                    ...
                    <div class="position-relative form-group">
                        ...
                        <input name="tb_sumber_dana_nama" type="text" class="form-control" required>
                    </div>
                </form>
            </div>
...
<script type="text/javascript">
    ...
    var link = 'pengaturan/data/sumber-dana';
    var page = 1;
    getData();
    ...
    function setTable(data){
        ...
        data.forEach(element => {
            kodeOneData = element['id_tb_sumber_dana'];
            tempData = [
                no,
    ...
    function getDataPilih(id){
        ...
        dataAll.forEach(element => {
            if(id == element['id_tb_sumber_dana'] ){
                dataPilih = element;
                kode = id;
            }
        });
    ...
    function setForm(data){
        ...
        $("input[name='tb_sumber_dana_nama']").val(data['tb_sumber_dana_nama']);
    }

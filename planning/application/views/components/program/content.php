                        ...
                        <div class="app-page-title" >
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions">
                                    <a href="<?=base_url()?>rpjmd/penyusunan/opd/<?=$kode?>" data-toggle="tooltip" title="Kembali" data-placement="bottom" class="btn-shadow mr-3 btn btn-info">
                                            ...
                                            <div>
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="10">:</td>
                                                        <td><a href="<?=base_url()?>rpjmd/penyusunan/opd/<?=$kode?>"><?="(".@$dataRpjmd->tb_rpjmd_sasaran_kode.") ".@$dataRpjmd->tb_rpjmd_sasaran_nama?></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="80">OPD</td>
                                                        <td width="10">:</td>

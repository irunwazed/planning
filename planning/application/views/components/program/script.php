...
<div class="modal fade bd-example-modal-lg" id="modal-indikator" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-indikator" action="<?=base_url()?>rpjmd/penyusunan/program/indikator">
...
<script type="text/javascript">
    ...
    var link = 'rpjmd/penyusunan/program';
    var page = 1;
    getData();
    ...
    function setForm(data){
        ...
        $("input[name='tb_rpjmd_program_th_awal_target_kinerja']").val(data['tb_rpjmd_program_th_awal_target_kinerja']);
        $("input[name='tb_rpjmd_program_th_awal_target_realisasi']").val(data['tb_rpjmd_program_th_awal_target_realisasi']);
        ...
        $("input[name='tb_rpjmd_program_th_akhir_target_kinerja']").val(data['tb_rpjmd_program_th_akhir_target_kinerja']);
        $("input[name='tb_rpjmd_program_th_akhir_target_realisasi']").val(data['tb_rpjmd_program_th_akhir_target_realisasi']);
    }

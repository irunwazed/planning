...
<div class="modal fade bd-example-modal-lg" id="modal-indikator" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-indikator" action="<?=base_url()?>opd/penyusunan/rkpd-perubahan/indikator">
...
<script type="text/javascript">
    ...
    var link = 'opd/penyusunan/rkpd-perubahan';
    var page = 1;
    ...
    function setTable(data){
        ...
        data.forEach(element => {
            ...
            tempData = [
                no,
                kodeShow,
                '<a href="'+base_url+'opd/penyusunan/rkpd-perubahan/kegiatan/'+kodeOneData+'">'+element['tb_program_nama']+'</a>',
                '<div>'+

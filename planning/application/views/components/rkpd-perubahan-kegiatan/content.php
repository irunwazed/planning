                        ...
                        <div class="app-page-title" >
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions">
                                    <a href="<?=base_url()?>opd/penyusunan/rkpd-perubahan" data-toggle="tooltip" title="Kembali" data-placement="bottom" class="btn-shadow mr-3 btn btn-info">
                                            ...
                                            <div>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td width="10">:</td>
                                                        <td><a href="<?=base_url()?>opd/penyusunan/rkpd-perubahan"><?="(".@$dataRpjmd->tb_rpjmd_misi_kode.".".@$dataRpjmd->tb_rpjmd_tujuan_kode.".".@$dataRpjmd->tb_rpjmd_sasaran_kode.") ".@$dataRpjmd->tb_rpjmd_sasaran_nama?></a></td>
                                                    </tr>
                                                    <tr>

                        ...
                        <div class="app-page-title" >
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions">
                                    <a href="<?=base_url()?>pengaturan/data/sotk/program/<?=@$kode?>" data-toggle="tooltip" title="Kembali" data-placement="bottom" class="btn-shadow mr-3 btn btn-info">
                                            ...
                                            <div>
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="10">:</td>
                                                        <td><a href="<?=base_url()?>pengaturan/data/sotk/program/<?=@$kode?>">(<?=@$dataSotk->tb_bidang_kode?>) <?=@$dataSotk->tb_bidang_nama?></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="80">Program</td>
                                                        <td width="10">:</td>
                                                        <td>(<?=@$dataSotk->tb_program_kode?>) <?=@$dataSotk->tb_program_nama?></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div class="page-title-wrapper">

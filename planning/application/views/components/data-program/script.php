            ...
            <div class="modal-body">
                <form id="form-data">
                    ...
                    <div class="position-relative form-group">
                        <label>Kode</label>
                        <input name="tb_program_kode" type="number" class="form-control col-sm-2" required>
                    </div>
                    <div class="position-relative form-group">
                        <label>Program</label>
                        <input name="tb_program_nama" type="text" class="form-control" required>
                    </div>
                </form>
            </div>
...
<script type="text/javascript">
    ...
    var link = 'pengaturan/data/sotk/program';
    var page = 1;
    getData();
    ...
    function setTable(data){
        ...
        data.forEach(element => {
            ...
            tempData = [
                no,
                kodeShow,
                '<a href="'+base_url+'pengaturan/data/sotk/kegiatan/'+kodeOneData+'">'+element['tb_program_nama']+'</a>',
    ...
    function setForm(data){
        ...
        $("input[name='tb_program_kode']").val(data['tb_program_kode']);
        $("input[name='tb_program_nama']").val(data['tb_program_nama']);
    }

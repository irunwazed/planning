                                            ...
                                            <div>
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="10">:</td>
                                                        <td><a href="<?=base_url()?>pengaturan/data/sotk/unit/<?=@$kode?>">(<?=@$dataSotk->tb_bidang_kode?>) <?=@$dataSotk->tb_bidang_nama?></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="80">Unit</td>
                                                        <td width="10">:</td>
                                                        <td>(<?=@$dataSotk->tb_unit_kode?>) <?=@$dataSotk->tb_unit_nama?></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div class="page-title-wrapper">

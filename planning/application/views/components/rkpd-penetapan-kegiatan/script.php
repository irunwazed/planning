...
<div class="modal fade bd-example-modal-lg" id="modal-indikator" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-indikator" action="<?=base_url()?>opd/penyusunan/rkpd-penetapan/kegiatan/indikator">
...
<script type="text/javascript">
    ...
    var link = 'opd/penyusunan/rkpd-penetapan/kegiatan';
    var page = 1;
    ...
    function setTable(data){
        ...
        data.forEach(element => {
            ...
            tempData = [
                ...
                element['tb_rpjmd_kegiatan_target_kinerja'],
                convertToRupiah(element['tb_rpjmd_kegiatan_target_realisasi']),
                element['tb_rpjmd_kegiatan_catatan'],
    ...
    function getDataPilih(id){
        ...
        dataAll.forEach(element => {
            ...
            && setKode[9] == element['tb_kegiatan_kode'] ){
                dataPilih = element;
                kode = id;
            }
        });

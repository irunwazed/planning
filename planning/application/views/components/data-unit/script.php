            ...
            <div class="modal-body">
                <form id="form-data">
                    ...
                    <div class="position-relative form-group">
                        <label>Kode</label>
                        <input name="tb_unit_kode" type="number" class="form-control col-sm-2" required>
                    </div>
                    <div class="position-relative form-group">
                        <label>Unit</label>
                        <input name="tb_unit_nama" type="text" class="form-control" required>
                    </div>
                </form>
            </div>
...
<script type="text/javascript">
    ...
    var link = 'pengaturan/data/sotk/unit';
    var page = 1;
    getData();
    ...
    function setTable(data){
        ...
        data.forEach(element => {
            ...
            kodeShow = element['tb_unit_kode'];
            tempData = [
                no,
                kodeShow,
                '<a href="'+base_url+'pengaturan/data/sotk/sub-unit/'+kodeOneData+'">'+element['tb_unit_nama']+'</a>',
    ...
    function getDataPilih(id){
        ...
        dataAll.forEach(element => {
            ...
            && setKode[2] == element['tb_unit_kode'] ){
                dataPilih = element;
                kode = id;
            }
        });
    ...
    function setForm(data){
        ...
        $("input[name='tb_unit_kode']").val(data['tb_unit_kode']);
        $("input[name='tb_unit_nama']").val(data['tb_unit_nama']);
    }

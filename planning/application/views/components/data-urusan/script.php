            ...
            <div class="modal-body">
                <form id="form-data">
                    ...
                    <div class="position-relative form-group">
                        <label>Kode</label>
                        <input name="tb_urusan_kode" type="number" class="form-control col-sm-2" required>
                    </div>
                    <div class="position-relative form-group">
                        <label>Urusan</label>
                        <input name="tb_urusan_nama" type="text" class="form-control" required>
                    </div>
                </form>
            </div>
...
<script type="text/javascript">
    ...
    var link = 'pengaturan/data/sotk/urusan';
    var page = 1;
    getData();
    ...
    function setTable(data){
        ...
        data.forEach(element => {
            ...
            tempData = [
                no,
                kodeShow,
                '<a href="'+base_url+'pengaturan/data/sotk/bidang/'+kodeOneData+'">'+element['tb_urusan_nama']+'</a>',
    ...
    function setForm(data){
        ...
        $("input[name='tb_urusan_kode']").val(data['tb_urusan_kode']);
        $("input[name='tb_urusan_nama']").val(data['tb_urusan_nama']);
    }

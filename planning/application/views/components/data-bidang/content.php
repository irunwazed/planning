                        ...
                        <div class="app-page-title" >
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions">
                                    <a href="<?=base_url()?>pengaturan/data/sotk/urusan" data-toggle="tooltip" title="Kembali" data-placement="bottom" class="btn-shadow mr-3 btn btn-info">
                                            ...
                                            <div>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td width="10">:</td>
                                                        <td>(<?=@$dataSotk->tb_urusan_kode?>) <?=@$dataSotk->tb_urusan_nama?></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div class="page-title-wrapper">

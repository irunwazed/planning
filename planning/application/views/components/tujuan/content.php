                        ...
                        <div class="app-page-title" >
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions">
                                    <a href="<?=base_url()?>rpjmd/penyusunan/misi" data-toggle="tooltip" title="Kembali" data-placement="bottom" class="btn-shadow mr-3 btn btn-info">
                                            ...
                                            <div>
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td width="80">Misi</td>
                                                        <td width="10">:</td>
                                                        <td><?="(".@$dataRpjmd->tb_rpjmd_misi_kode.") ".@$dataRpjmd->tb_rpjmd_misi_nama?></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div class="page-title-wrapper">

            ...
            <div class="modal-body">
                <form id="form-data">
                    ...
                    <div class="position-relative form-group">
                        ...
                        <input name="tb_rpjmd_misi_kode" type="number" class="form-control col-sm-2" required>
                    </div>
                    <div class="position-relative form-group">
                        <label>Misi</label>
                        <input name="tb_rpjmd_misi_nama" type="text" class="form-control" required>
                    </div>
                </form>
            </div>
...
<script type="text/javascript">
    ...
    var link = 'rpjmd/penyusunan/misi';
    var page = 1;
    getData();
    ...
    function setTable(data){
        ...
        data.forEach(element => {
            ...
            tempData = [
                no,
                element['tb_rpjmd_misi_kode'],
                '<a href="'+base_url+'rpjmd/penyusunan/tujuan/'+kodeOneData+'">'+element['tb_rpjmd_misi_nama']+'</a>',
    ...
    function getDataPilih(id){
        ...
        dataAll.forEach(element => {
            if(id == element['tb_rpjmd_misi_kode'] ){
                dataPilih = element;
                kode = id;
            }
        });
    ...
    function setForm(data){
        ...
        $("input[name='tb_rpjmd_misi_kode']").val(data['tb_rpjmd_misi_kode']);
        $("input[name='tb_rpjmd_misi_nama']").val(data['tb_rpjmd_misi_nama']);
    }
